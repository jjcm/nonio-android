...
import com.nonio.android.video.cache.VideoPlayerCacheManager
...
import com.nonio.android.video.pip.enterPIPMode
import com.nonio.android.video.pip.isActivityStatePipMode
import com.nonio.android.video.uri.VideoPlayerMediaItem
import com.nonio.android.video.uri.toUri
        ...
        VideoPlayerFullScreenDialog(
            ...
            onDismissRequest = {
                fullScreenPlayerView?.let {
                    ...
                    defaultPlayerView
                        .findViewById<ImageButton>(R.id.exo_fullscreen)
                        .performClick()
